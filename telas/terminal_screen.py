...
class TerminalScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.totalBox = QLabel(
            "R$ 0,00"
        )

        self.totalBox.setObjectName(
            "totalBox"
        )

        self.totalBox.setAlignment(
            Qt.AlignCenter
        )
        ...
        self.cabecalho = QLabel(
            "ID        CÓDIGO        PRODUTO        PESO(KG)        VALOR"
        )
        ...
        self.productsLayout.setAlignment(
            Qt.AlignTop
        )
        ...
        self.codigo_barras.returnPressed.connect(
            self.readProduct
        )
        ...
        self.peso_display.setReadOnly(
            True
        )

        layout_inputs.addWidget(
            self.codigo_barras
        )
        ...
        self.timer_foco.timeout.connect(
            self.garantir_foco
        )
    ...
    def ir_para_pagamento(self):
        ...
        self.parent.pagamento.total_final.setText(
            valor_final
        )
    ...
    def remover_produto(
        ...
        self.peso_display.setText(
            f"{max(0, self.peso_total_venda):.3f} KG"
        )
